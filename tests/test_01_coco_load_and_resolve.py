...
# Import helper from your pipeline
from coco_pipeline_revised import _resolve_image_path
...
def test_load_coco_and_resolve_one_image():
    ...
    assert img_path.exists(), f"COCO image not found via resolver: {img_path}"
